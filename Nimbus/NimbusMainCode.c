...
#pragma config(Motor,  port9,           rightFront,    tmotorVex393_MC29, openLoop, reversed, driveLeft)
#pragma config(Motor,  port10,          rightRear,     tmotorVex393_HBridge, openLoop, reversed, driveRight)
