#pragma config(Motor,  port1,           leftRear,      tmotorVex393_HBridge, openLoop, driveLeft, reversed)
#pragma config(Motor,  port2,           leftFront,     tmotorVex393_MC29, openLoop, driveLeft, reversed)
...
#pragma config(Motor,  port9,           rightFront,    tmotorVex393_MC29, openLoop, driveLeft)
